...
$encoded_id = $_GET['article_id'] ?? '';
$article_id = decodeID($encoded_id);
...
$comment_total = $query_comment ? mysqli_num_rows($query_comment) : 0;
?>
<!-- start article -->
                                ...
                                <div class="row">
                                    <div class="col" style="--w-md: 6;">
                                        <div class="w-100 form__input">
                                            <!-- Mã hóa tên người dùng để bảo vệ khỏi XSS -->
                                            <input class="btn w-100" type="text" placeholder="Tên" name="comment_name" 
                                            value="<?php echo isset($_POST['comment_name']) ? htmlspecialchars($_POST['comment_name'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        </div>
                                    </div>
                                    <div class="col" style="--w-md: 6;">
                                        <div class="w-100 form__input">
                                            <!-- Mã hóa email người dùng để bảo vệ khỏi XSS -->
                                            <input class="btn w-100" type="email" placeholder="Email" name="comment_email" 
                                            value="<?php echo isset($_POST['comment_email']) ? htmlspecialchars($_POST['comment_email'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col" style="--w-md: 12;">
                                        <div class="w-100 form__input">
                                            <!-- Mã hóa nội dung bình luận để bảo vệ khỏi XSS -->
                                            <textarea class="btn w-100" placeholder="Nội dung bình luận" name="comment_content" rows="5">
                                                <?php echo isset($_POST['comment_content']) ? htmlspecialchars($_POST['comment_content'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
