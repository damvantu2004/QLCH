            ...
            <div class="row">
                <div class="col" style="--w-md: 7">
                    ...
                    <div class="payment__items">
                        ...
                        <div class="payment__item d-flex align-center">
                            <input class="payment__radio" type="radio" name="order_type" id="payment_vietqr" value="5" />
                            <img class="payment__icon" src="./assets/images/payment/vietqr.png" alt="QR CODE" style="width: 62px;">
                            <label class="payment__label w-100 h-100" for="payment_vietqr">
                                <span class="d-block">VietQR</span>
                                <span class="d-block">Thanh toán VietQR</span>
                            </label>
                        </div>
                    </div>
                </div>
