...
$sql_order_list = "SELECT * FROM orders JOIN account ON orders.account_id = account.account_id WHERE orders.order_type = 6 ORDER BY orders.order_id DESC LIMIT $begin,10";
