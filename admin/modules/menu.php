        ...
        <li class="nav-item <?php if ($action === 'order') { echo "active"; } ?>">
            ...
            <div class="collapse <?php if ($action === 'order') { echo "show"; } ?>" id="orders">
                <ul class="nav flex-column sub-menu">
                    ...
                    <!-- <li class="nav-item <?php if ($query === 'order_payment') { echo "active"; } ?>"> <a class="nav-link" href="index.php?action=order&query=order_payment">Lịch sử thanh toán</a></li> -->

                    <li class="nav-item <?php if ($query === 'order_payment') { echo "active"; } ?>">
                        <a class="nav-link" href="https://my.payos.vn/86933c2e7e3611ef99770242ac110002/dashboard" target="_blank">Lịch sử thanh toán</a>
                    </li>
